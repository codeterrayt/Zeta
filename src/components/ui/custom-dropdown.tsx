...
export function CustomDropdown({ value, onChange, options, icon: Icon, label, className }: CustomDropdownProps) {
  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-4 py-2 rounded-2xl border transition-all group min-w-[150px] w-full",
